...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Recover revenue you're already losing. KOLVAX runs in the background so business owners can focus on running the business." },
